...
test('M7-02 aligne release, précache, documentation et rollback', () => {
    ...
    assert.match(layout, /APP_VERSION = 'v2\.22\.3'/u);
    assert.match(sw, /APP_VERSION = 'v2\.22\.3'/u);
    assert.match(app, /app-version" content="v2\.22\.3"/u);
    assert.match(changelog, /^## \[2\.22\.3\] - 2026-09-23\r?\n/u);
