...
test('M7-02 aligne release, précache, documentation et rollback', () => {
    ...
    assert.match(layout, /APP_VERSION = 'v2\.22\.0'/u);
    assert.match(sw, /APP_VERSION = 'v2\.22\.0'/u);
    assert.match(app, /app-version" content="v2\.22\.0"/u);
