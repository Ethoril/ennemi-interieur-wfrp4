...
- **CSS** : D�coupage du fichier monolithique style.css en fichiers s�par�s (ase.css, layout.css, components.css, pnjs.css) pour une meilleure maintenabilit�.
- **PNJs (Graphe D3)** : Accentuation de l'effet de focus (assombrissement plus fort des n�uds non connect�s au clic).
